...
export interface paths {
    ...
    "/api-bicicletario/ponto/bicicleta": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["Ciclista"][];
                        "application/json": components["schemas"]["Ciclista"][];
                        "text/json": components["schemas"]["Ciclista"][];
                    };
                };
            };
        };
        ...
        get: {
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "text/plain": components["schemas"]["PardonRequest"][];
                        "application/json": components["schemas"]["PardonRequest"][];
                        "text/json": components["schemas"]["PardonRequest"][];
                    };
                };
            };
        };
